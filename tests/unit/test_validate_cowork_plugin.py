"""Unit tests for scripts/validate_cowork_plugin.py (skills source)."""
...
from scripts import validate_cowork_plugin as validator


def test_validate_cowork_plugin_tree_passes_on_repo_skills() -> None:
    assert validator.validate_cowork_plugin_tree() == []
