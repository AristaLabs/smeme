...
from smeme.decision_tree.helpers.validation import validate_graph_for_editing, validate_graph_for_generation
...
def _funnel_graph() -> DTGraph:
    ...
    return DTGraph(
        ...
        metadata=DTGraphMetadata(title="Funnel fixture"),
    )
...
def _prefix_funnel_graph() -> DTGraph:
    ...
    return DTGraph(
        ...
        metadata=DTGraphMetadata(title="Prefix funnel"),
    )
...
def _intake_then_branch_graph() -> DTGraph:
    ...
    return DTGraph(
        ...
        metadata=DTGraphMetadata(title="Intake then branch"),
    )
...
def _branching_graph() -> DTGraph:
    return DTGraph(
        ...
        metadata=DTGraphMetadata(title="Good branching"),
    )
...
"""
    ...
    graph = DTGraph(
        ...
        metadata=DTGraphMetadata(title="Collect only"),
    )
