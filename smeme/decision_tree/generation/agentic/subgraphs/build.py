"""Build subgraph for agentic DecisionTree generation.
...
from smeme.decision_tree.generation.agentic.auto_fix import auto_fix_graph
from smeme.decision_tree.generation.agentic.branching_quality import (
...
from smeme.decision_tree.generation.agentic.design_parse import parse_collect_only_question_ids
from smeme.decision_tree.generation.agentic.prompts import BUILD_GRAPH_PROMPT
from smeme.decision_tree.generation.agentic.subgraphs.models import (
    BuildSubgraphInput,
    BuildSubgraphOutput,
    BuildSubgraphState,
)
from smeme.decision_tree.helpers.validation import validate_graph_for_generation
...
async def build_graph_node(
    ...
    try:
        ...
        from smeme.decision_tree.generation.agentic.helpers import (
            LLMSimpleGraph,
