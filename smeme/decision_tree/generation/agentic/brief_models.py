...
from smeme.decision_tree.generation.agentic.validation import parse_and_validate_include_urls


class GenerationBriefInput(BaseModel):
    """Input for the guided brief form (POST /decision-trees/agentic/generate).
    ...
    title: str = Field(
        ...
        min_length=3,
        max_length=200,
        description="User-provided DecisionTree name",
    )
