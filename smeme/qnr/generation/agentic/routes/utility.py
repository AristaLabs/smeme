...
async def view_generation(
    ...
    try:
        ...
        if state_snapshot.next:
            ...
            if "questionnaire_design" in state and not state.get("qnr_id"):
                await track_wizard_resume_enter(
                    db,
                    user_id=user.id,
                    phase="design",
...
async def delete_generation(
    ...
    if is_htmx:
        ...
        return templates.TemplateResponse(
            "qnr/_dashboard_in_progress.html",
            {
                "request": request,
    ...
    return RedirectResponse(url="/qnr/dashboard?generation_deleted=1", status_code=303)
    ...
    try:
        ...
        if state_snapshot.next:
            ...
            logger.debug(
                ...
                f"qnr_id={state.get('qnr_id') is not None}"
            )
        ...
        logger.info(
            ...
            f"has_qnr_id={qnr_id is not None}, "
