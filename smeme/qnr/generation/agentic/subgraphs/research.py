...
from smeme.qnr.generation.agentic.file_limits import MAX_EXTRACTED_TEXT_CHARS

# EXCLUDE_DOMAINS moved from nodes/research.py to make subgraph self-contained
from smeme.qnr.generation.agentic.prompts import (
...
async def _stream_research_completion(
    ...
    *,
    ...
    from smeme.qnr.generation.agentic.streaming import put_event
