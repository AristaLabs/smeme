...
description: >-
  Handle the evaluate report when result_kind is not concluded — multiple outcomes,
...
Never invent branch rules to predict outcomes — let the server decide via these tools or evaluate.
