...
**Core `main` tip at audit:** includes `C5` = `695ba493925d76c828d58fd2b2db2c91d519ef00`  
...
| §7 | MCP evaluate ingest → exact offered-option validation → exact IR-label projection; assumptions via tool params | `test_answer_option_requires_exact_offered_string`; `test_case_distinct_options_project_only_exact_admitted_label`; remaining goldens + `test_assumptions.py` (`C5`) | Pass |
